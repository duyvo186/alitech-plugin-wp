...
class CustomPostTypeController extends BaseController
{
	...
	public function setSubpages()
	{
		$this->subpages = array(
			array(
				'parent_slug' => 'alitech_plugin',
				'page_title' => 'Custom Post Types', 
				'menu_title' => 'CPT Manager', 
				'capability' => 'manage_options', 
				'menu_slug' => 'alitech_plugin_cpt',
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'alitech_plugin_cpt_settings',
				'option_name' => 'alitech_plugin_cpt',
	...
	public function setFields()
	{
		$args = array(
			...
			array(
				...
				'callback' => array( $this->cpt_callbacks, 'textField' ),
				'page' => 'alitech_plugin_cpt',
				'section' => 'alitech_plugind_cpt_index',
				'args' => array(
					'option_name' => 'alitech_plugin_cpt',
			...
			array(
				...
				'callback' => array( $this->cpt_callbacks, 'textField' ),
				'page' => 'alitech_plugin_cpt',
				'section' => 'alitech_plugin_cpt_index',
				'args' => array(
					'option_name' => 'alitech_plugin_cpt',
	...
	{
		$options = get_option( 'alitech_plugin_cpt' ) ?: array();
