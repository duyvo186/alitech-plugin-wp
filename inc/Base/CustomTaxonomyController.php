...
class CustomTaxonomyController extends BaseController
{
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'alitech_plugin_tax_settings',
				'option_name' => 'alitech_plugin_tax',
	...
	{
		$options = get_option( 'alitech_plugin_tax' ) ?: array();
